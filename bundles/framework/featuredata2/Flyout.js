    ...
    function (instance) {
        ...
        _prepareData: function (layer) {
            var me = this,
                ...
                allowLocateOnMap = this.instance && this.instance.conf && this.instance.conf.allowLocateOnMap;
            ...
            if (isOk) {
                ...
                if (allowLocateOnMap) {
                    fields.unshift(me.instance.getLocalization('locate_on_map'));
                }
                ...
                if (panel.propertiesChanged) {
                    ...
                    if(allowLocateOnMap) {
                        visibleFields.unshift(me.instance.getLocalization('locate_on_map'));
                    }
                ...
                if (allowLocateOnMap) {
                    panel.grid.setColumnUIName(me.instance.getLocalization('locate_on_map'), ' ');
                    panel.grid.setColumnValueRenderer(me.instance.getLocalization('locate_on_map'), function(name, data) {
