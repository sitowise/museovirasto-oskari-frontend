Oskari.clazz.category('Oskari.mapframework.mapmodule.GetInfoPlugin', 'formatter', {
    ...
    _formatRegistryFeaturesForInfoBox: function (data) {
        var me = this,
            ...
            fields,
            hiddenFields = ['__fid', '__centerX', '__centerY', 'subItems', 'areas', 'itemtype', 'geometry', 'pointGeometry', 'areaGeometry', 
                'mapLayers', 'bounds', 'filtered', 'lines', 'points', 'subAreas', 'editable'],
            type = 'wfslayer',
            result,
            markup,
