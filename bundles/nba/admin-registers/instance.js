/**
 * @class Oskari.nba.bundle.admin-registers.AdminRegisterRightsBundleInstance
 *
 * Main component and starting point for the layer rights management functionality.
 *
 * See Oskari.nba.bundle.admin-registers.AdminRegisterRightsBundle for bundle definition.
 *
 */
Oskari.clazz.define("Oskari.nba.bundle.admin-registers.AdminRegisterRightsBundleInstance",
    ...
    function () {
        ...
        startExtension: function () {
            ...
            this.plugins['Oskari.userinterface.Flyout'] =
                Oskari.clazz.create('Oskari.nba.bundle.admin-registers.Flyout', this);
            this.plugins['Oskari.userinterface.Tile'] =
                Oskari.clazz.create('Oskari.nba.bundle.admin-registers.Tile', this);
        },
