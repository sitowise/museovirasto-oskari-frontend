...
/**
 * @class Oskari.nba.bundle.admin-registers.Flyout
 *
 * Renders the layer rights management flyout.
 */
Oskari.clazz.define('Oskari.nba.bundle.admin-registers.Flyout',

    /**
     * @method create called automatically on construction
     * @static
     * @param {Oskari.nba.bundle.admin-registers.AdminRegisterRightsBundleInstance}
    ...
    function (instance) {
        ...
        getName : function () {
            "use strict";
            return 'Oskari.nba.bundle.admin-registers.Flyout';
        },
        ...
        setEl : function (el, width, height) {
            "use strict";
            this.container = el[0];
            if (!jQuery(this.container).hasClass('admin-registers')) {
                jQuery(this.container).addClass('admin-registers');
            }
        },
        ...
        startPlugin : function () {
            ...
            this.template = jQuery(
                '<div class="admin-registers">\n' +
                    '   <form method="post" id="admin-registers-form">' +
                    '       <label><span></span>' +
                    '          <select class="admin-registers-role"></select>\n' +
                    '       </label>' +
                    '       <div class="admin-registers-layers">' +
                    '       </div>' +
            ...
            jQuery(elParent).addClass('admin-registers-flyout');
        },
        ...
        */
        doSave : function () {
            ...
            jQuery.ajax({
                type: 'POST',
                url: ajaxUrl + 'action_route=SaveRegisterPermission',
                lang: Oskari.getLang(),
        ...
        setContent : function (content) {
            ...
            var me = this,
                ...
                roleSelect = container.find('select.admin-registers-role');
        ...
        handleRoleChange: function (role, operation) {
            var me = this,
                select = jQuery(this.container).find('select.admin-registers-role'),
        ...
        updatePermissionsTable : function (activeRole, externalType) {
            ...
            jQuery.getJSON(ajaxUrl, {
                action_route: "GetRegistryPermissions",
                lang: Oskari.getLang(),
                timestamp: new Date().getTime(),
               ...
               //resourceType: "WMS_LAYER",
                ...
                jQuery(me.container).find('.admin-registers-layers').empty().append(table);
            });
        },
        ...
        makeExternalIdsSelect : function (result, externalType, selectedId) {
            "use strict";
            var externalIdSelect = jQuery(this.container).find("select.admin-registers-role"),
                a,
                d,
                rightsLoc = this.instance._localization.rights;
